...
th,td{
 ...
 <div class="topnav" style="background-color:#000000;" >
  ...
  <a class="active" href="index.php" style="float:left" style="background-color:rgb(55,55,55);
  ...
  <a href="signup.php" style="float:right">Signup</a>
           ...
           <div  style="width:1350px;height:800px;padding:50px 50px;"> 
                ...
                <div class="table-responsive" style="background-color:#aaa;">  
					 ...
					 <form action="index.php" method="POST"><input type="submit" name="payment" 
					 style="margin-top:5px;background-color:white; border-color:black;border-radius: 4px;" class="btn btn-success" value="BUY" </input></form>	
</form>					 
                </div>  
           </div>  
           <br />  
