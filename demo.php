...
th,td{
 ...
 <div class="topnav" style="background-color:#000000;" >
  ...
  <a class="active" href="demo.php" style="float:left" style="background-color:rgb(55,55,55);
  color: white;">Sunglass</a>
  ...
  <a href="signup.php" style="float:right">Signup</a>
           ...
           <div  style="width:1350px;height:800px;padding:50px 50px;">  
                ...
                <div  style="margin:50px 50px;height:300px;float:left">  
                     <form method="post" action="demo.php?action=add&id=<?php echo $row["id"]; ?>">  
                          <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;width:300px;height:350px;float:left;" align="center">  
                               ...
                               <input type="submit" name="add_to_cart" style="margin-top:5px;background-color:white; border-color:black;" class="btn btn-success" value="Add to Cart" />  
                          </div>  
                     </form>  
                </div>
                ...
                <br />  
                <h3>Order Details</h3>  
                <div class="table-responsive" style="background-color:#aaa;">  
                     <table class="">  
                          <tr>  
...
<form action="demo.php" method="POST"><input type="submit" name="payment" style="margin-top:5px;background-color:white; border-color:black;" class="btn btn-success" value="BUY"></input></form>					 
                </div>  
           </div>  
           <br /> 

<!--<div style="width:1350px;height:100px;background-color:black;"></div>-->		   
      </body>  
 </html>
