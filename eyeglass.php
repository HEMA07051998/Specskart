...
th,td{
 ...
 <div class="topnav" style="background-color:#000000;" >
  ...
  <a class="active" href="eyeglass.php" style="float:left" style="background-color:rgb(55,55,55);
  color: white;">Eye glasses</a>
  ...
  <a href="signup.php" style="float:right">Signup</a>
           ...
           <div  style="width:1350px;height:800px;padding:50px 50px;">  
                ...
                <div  style="margin:50px 50px;height:300px;float:left">  
                     <form method="post" action="eyeglass.php?action=add&id=<?php echo $row["id"]; ?>">  
...
<form action="index.php" method="POST"><input type="submit" name="payment" style="margin-top:5px;background-color:white; border-color:black;black;border-radius: 4px;" class="btn btn-success" value="BUY"></input></form>					 
                </div>  
           </div>  
           <br />  
      </body>  
